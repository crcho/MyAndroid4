...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityMainBinding.foreignButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                activityMainBinding.foreignButton.setTextColor(Color.GREEN);
                activityMainBinding.domesticButton.setTextColor(Color.MAGENTA);
            }
        });
    ...
    // 파라미터 없는 목록 가져오기
    private void initializeArrayListNoParam() {
        activityMainBinding.domesticButton.setTextColor(Color.BLUE);

        try{
            //NetworkTask networkTask = new NetworkTask("http://10.0.2.2:3300/v1/chart/","domestic");
            NetworkTask networkTask = new NetworkTask("http://10.0.2.2:3300/v1/chart/");
            networkTask.execute();
        }catch (Exception e){
            e.printStackTrace();
        }
    ...
    private void initializeDomesticArrayList() {
        activityMainBinding.domesticButton.setTextColor(Color.GREEN);
    ...
    private void initializeOverseasArrayList() {
        ...
        activityMainBinding.foreignButton.setTextColor(Color.MAGENTA);
        try{
    ...
    public class NetworkTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            // 파리미터 없는는 경우
            result = requestHttpURLConnection.HttpURLConnectionGet(url);
